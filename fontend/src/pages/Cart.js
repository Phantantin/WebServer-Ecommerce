...
import { deleteCartProdcuct, getUserCart, updateCartProdcuct } from '../features/user/userSlice';
...
const Cart = () => {
    ...
    useEffect(()=>{
        if(productUpdateDetail !== null){
            dispatch(updateCartProdcuct({cartItemId:productUpdateDetail?.cartItemId, quantity:productUpdateDetail?.quantity}));
            setTimeout(()=>{
                dispatch(getUserCart());
            },200);
        }
    ...
    const deleteACartProduct = (id)=>{
        dispatch(deleteCartProdcuct(id));
        setTimeout(()=>{
            dispatch(getUserCart());
        },200);
    };
                                    ...
                                    <div className='cart-col-3 d-flex align-items-center gap-15'>
                                        <div>
                                            <input 
                                                ...
                                                min={1}
                                                max={10}
                                                value={productUpdateDetail?.quantity ? productUpdateDetail:item?.quantity}
