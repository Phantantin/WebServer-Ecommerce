    ...
    <Container class1="cart-wrapper home-wrapper-2 py-5">
        <div className="row">
            ...
            <div className="col-12">
                ...
                <div className="mb-3">
                    <label htmlFor="exampleInputEmail1" disabled={edit} className="form-label">Email address</label>
                ...
                <div className="mb-3">
                    <label htmlFor="exampleInputEmail2" className="form-label" disabled={edit}>Mobile No</label>
