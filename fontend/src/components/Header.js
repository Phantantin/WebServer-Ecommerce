            ...
            <div className="row">
              ...
              <div className="col-6">
                <p className='text-end text-white mb-0'>
                  HotLine: <a className='text-white' href='tel:+84 962187125'>+84 962187125</a>
                </p>
              </div>
            </div>
        </div>
              ...
              <div>
                <Link to="/cart" className='d-flex align-items-center gap-10 text-white'>
                  ...
                  <div className='d-flex flex-column gap-10'>
                    <span className='badge bg-warning text-dark'>{cartState?.length ? cartState?.length : 0}</span>
                ...
                <div>
                  <div className="dropdown">
                    <button className="btn btn-secondary dropdown-toggle bg-transparent border-0 gap-15 d-flex align-items-center" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                      ...
                      <img src={menu} alt="" />  
                      <span className='me-5 d-d-inline-block'>Shop Categories</span> 
                    </button>
