...
const Addproduct = () => {
  ...
  const { isSuccess, isError, isLoading, createProduct,
    productName, productDesc, productCategory, productBrand,
    productTags, productPrice, productQuantity, productImages, updatedProduct } = newProduct;
