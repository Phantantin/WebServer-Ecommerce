...
export const getCategories = createAsyncThunk("productCategory/get-categories", 
async(thunkAPI)=>{
    try {
...
export const getAProductCategory = createAsyncThunk(
    ...
    async (id, thunkAPI) => {
      try {
        return await pcategoryService.getProductsCategory(id);
      } catch (error) {
        return thunkAPI.rejectWithValue(error);
      }
    }
...
async(category, thunkAPI)=>{
    try {
        return await pcategoryService.updateProductsCategory(category);
    } catch (error) {
        return thunkAPI.rejectWithValue(error);
    }
});
