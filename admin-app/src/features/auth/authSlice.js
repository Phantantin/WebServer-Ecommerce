...
const getUserfromLocalStoragge = localStorage.getItem("user")? 
JSON.parse(localStorage.getItem("user")): null;

const initialState = {
    user: getUserfromLocalStoragge,
    orders: [],
    isError: false,
    isLoading: false,
    isSuccess: false,
...
export const getOrders = createAsyncThunk("order/get-orders", 
async(thunkAPI)=>{
    try {
...
export const getOrder = createAsyncThunk("order/get-order", 
async(id, thunkAPI)=>{
    try {
...
export const updateAOrder = createAsyncThunk("order/update-order", 
async(data, thunkAPI)=>{
    try {
