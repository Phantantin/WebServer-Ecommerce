...
export const getBrands = createAsyncThunk("brand/get-brands", 
async(thunkAPI)=>{
    try {
...
export const createBrand = createAsyncThunk("brand/create-brand", 
...
export const updateABrand = createAsyncThunk("brand/update-brand", 
